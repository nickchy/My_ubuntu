...
call <SID>AddAlternateExtensionMapping('h',"c,tpp,cpp,cxx,cc,CC")
call <SID>AddAlternateExtensionMapping('H',"C,tpp,CPP,CXX,CC")
call <SID>AddAlternateExtensionMapping('hpp',"tpp,cpp,c")
call <SID>AddAlternateExtensionMapping('HPP',"tpp,CPP,C")
