...
" and on Easwy Yang's version:
"       http://github.com/easwy/share/tree/master/vim/vimrc/
"
" Maintainer:  Nick Yang Cai
" Last Change: Aug 2012
" Version:     1.0
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
"Sets how kany lines of history VIM har to remember
set history=400
...
if MySys() == "linux"
  if has("gui_running")
    set gfn=Courier\ New\ 16,Courier\ 12,Luxi\ Mono\ 12,
...
"set mat=2
  ...
  function! CurDir()
     let curdir = substitute(getcwd(), '/home/nick/', "~/", "g")
     return curdir
  endfunction
...
" Alt-d deletes blank line below, and Alt-l inserts.
...
au FileType java,c,cpp,tpp setl shiftwidth=4
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
   ...
   elseif MySys() == "linux"
     ...
     runtime ~/.vim/plugin/taglist.vim
   """"""""""""""""""""""""""""""
   " winmanager setting
   """"""""""""""""""""""""""""""
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
   ...
   nmap <leader>cw :botright cw 10<cr>
